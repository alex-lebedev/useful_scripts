...
for i = 1:size(slist,1)
        ...
        img_nb2 = load_nii(strcat('/Volumes/REBOOT-I/REBOOT_BLdpabi/spm/nBack/',slist(i,1).name, '/con_0001.nii'));
        img_nb3 = load_nii(strcat('/Volumes/REBOOT-I/REBOOT_BLdpabi/spm/nBack/',slist(i,1).name, '/con_0002.nii'));
        img_rB = load_nii(strcat('/Volumes/REBOOT-I/REBOOT_BLdpabi/spm/reason/',slist(i,1).name, '/con_0001.nii'));
        img_rC = load_nii(strcat('/Volumes/REBOOT-I/REBOOT_BLdpabi/spm/reason/',slist(i,1).name, '/con_0002.nii'));
